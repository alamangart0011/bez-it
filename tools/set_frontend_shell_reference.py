...
files = {
    ROOT / 'frontend/src/App.jsx': "import SignalumRoomBasedPreviewHtmlReferencePage from './preview/SignalumRoomBasedPreviewHtmlReferencePage.jsx';\n\nexport default SignalumRoomBasedPreviewHtmlReferencePage;\n",
